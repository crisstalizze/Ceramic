(() => {
    ...
    function liteSpoller(e) {
        const blockBut = document.querySelector(".catalog__items");
        const targetElement = e.target;
        if (targetElement.closest(".catalog__button")) targetElement.previousElementSibling.classList.toggle("active"); else blockBut.classList.remove("active");
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new Swiper(".feedback-slider", {
            modules: [ Navigation ],
            speed: 500,
            navigation: {
                prevEl: ".swiper-button-prev",
    ...
    function isOnVisibleSpace(element) {
        ...
        if (true) element.classList.add("visible");
    }
    ...
    onVisibleSpaceListener("catalog-items");
    onVisibleSpaceListener("about-text");
    onVisibleSpaceListener("about-pic");
    onVisibleSpaceListener("categories-items");
    onVisibleSpaceListener("shipping-text");
    onVisibleSpaceListener("shipping-pic");
    onVisibleSpaceListener("feedback-text");
    onVisibleSpaceListener("feedback-items");
    onVisibleSpaceListener("contact-text");
    onVisibleSpaceListener("contact-pic");
    window["FLS"] = true;
    isWebp();
})();